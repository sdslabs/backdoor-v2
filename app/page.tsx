					...
					<div className="flex flex-col lg:flex-row items-center justify-between gap-12">
						<div className="flex-1 space-y-8">
							<div className="flex items-center space-x-4">
								<h1 className="text-5xl font-bold leading-tight">Be a part of XYZ</h1>
							...
							<div className="space-y-4">
								<div>
									<h2 className="text-lg font-medium text-secondary-foreground">Starting Time</h2>
									<p className="text-xl font-semibold text-muted-foreground"></p>
								</div>
								<div>
									<h2 className="text-lg font-medium text-secondary-foreground">Ending Time</h2>
									<p className="text-xl font-semibold text-muted-foreground"></p>
								</div>
							</div>
